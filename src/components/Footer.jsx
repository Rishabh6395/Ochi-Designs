...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen font-foundersgrotesk bg-[#F1F1F1] text-[#212121] p-20'>
        ...
        <div className='w-1/2'>
        <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-10'>Presentations
        </h1>
        <div className='dets font-neueMontrealregular mt-10'>
                <h4 className='pt-5 pb-5'>S:</h4>
                ...
                <h4 className='pt-5 pb-5'>E:</h4>
                <a className='block text-xl font-light' href="#">hello@ochi.design</a>

                <h4 className='pt-16 text-sm text-zinc-600 pb-5'>© ochi design 2024 Legal Terms</h4>
        </div>
        </div>
    </div>
  )
